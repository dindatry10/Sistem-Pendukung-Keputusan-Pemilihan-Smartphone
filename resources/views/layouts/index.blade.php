...
<html lang="en">
  ...
  <head>
    ...
    <title>Sistem Pendukung Keputusan Smartphone</title>
...
<body>
        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            {{-- <a href="index.html" class="logo">
              <img src="{{asset('assets')}}/images/logos32.png" alt="Chain App Dev">
            </a> --}}
            <!-- ***** Logo End ***** -->
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
          ...
          <div class="row">
            <div class="col-lg-6 align-self-center">
              <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                <div class="row">
                  <div class="col-lg-12">
                    <h2>Sistem Pendukung Keputusan Smartphone</h2>
                    <p>Metode yang digunakan adalah metode TOPSIS. Metode TOPSIS adalah salah satu metode penyelesaian pada sistem pendukung keputusan.</p>
                  </div>
                  <div class="col-lg-12">
                    <div class="white-button first-button scroll-to-section">
                      <a href="{{ route('login') }}">Pilih Rekomendasi<i class="fa fa-solid fa-arrow-right"></i></a>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <script src="{{asset('assets')}}/js/owl-carousel2.js"></script>
