...
<body>
    ...
    <div class="p-3">
    <a href="{{ route ('list.add') }}" type="submit" class="btn btn-primary" style="margin-bottom:10px">Tambah Data</a>

    <div class="form-group">
    <form class="d-flex align-items-center" action="{{ route('list.find') }}" class="form-inline" method="GET">
        <div class="input-group">
          <input type="search" name="query" class="form-control" placeholder="Cari Data Smartphone" aria-label="Cari Data Smartphone" aria-describedby="basic-addon2" value="{{ request()->input('query') }}" />
