    ...
    <form action="{{ route('list.store') }}" method="POST" enctype="multipart/form-data">
      @csrf
        ...
        <div class="form-group mb-3">
          ...
          <input name="ram_angka" type="text" class="form-control" placeholder="Masukkan data angka ram smartphone" value="">
        </div>
        <div class="form-group mb-3">
          <label>Memori Angka</label>
          <input name="memori_angka" type="text" class="form-control" placeholder="Masukkan data angka memori smartphone" value="">
        </div>
        <div class="form-group mb-3">
          <label>Processor Angka</label>
          <input name="processor_angka" type="text" class="form-control" placeholder="Masukkan data angka procesor smartphone" value="">
        </div>
        <div class="form-group mb-3">
          <label>Kamera Angka</label>
          <input name="kamera_angka" type="text" class="form-control" placeholder="Masukkan data angka kamera smartphone" value="">
        </div>

        <a href="/admin/list" class="btn btn-secondary">Kembali</a>
        <button name="tambah_hp" type="submit" class="btn btn-primary">Tambah</button>
      </form>
</div>
</body>
@endsection