...
<body>
    ...
    <div class="p-3">
    <a href="{{ route ('listuser.add') }}" type="submit" class="btn btn-primary" style="margin-bottom:10px"><i class="btn-md mdi mdi-file-check btn-icon-prepend"></i>Tambah Data</a>

    <div class="form-group">
    <form class="d-flex align-items-center" action="/user/search" class="form-inline" method="GET">
    ...
    <table class="table table-hover table-striped table-bordered ">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route ('listuser.edit', ['id_hp' => $item->id_hp]) }}" 
    ...
    <script>
        function hapus(id_hp) {
            ...
            if (confirm('Anda yakin ingin menghapus data?')){
                $.ajax({
                    type: "get",
                    url: "{{ route('listuser.hapus')}}/" + id_hp,
                    data: {
                        "id_hp": id_hp
                    },
