...
<body>
    ...
    <hr>
    <form action="{{ route('user.hasil')}}" method="POST" enctype="multipart/form-data">
      @csrf
        ...
        <center><input type="submit" class="btn btn-primary btn-block col-2" style="margin-bottom:20px" value="Hitung"></center>
      </form>
    </div>
