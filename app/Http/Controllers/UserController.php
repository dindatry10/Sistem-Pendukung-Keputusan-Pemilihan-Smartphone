...
class UserController extends Controller
{
    public function list()
    {
        ...
        // CHECK DATA
        // dd($data['list']);
        return view('dashboards.users.list.list', $data);
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('dashboards.users.list.list', ['data' => $data]);
    }
    ...
    public function edit($id_hp)
    {
        ...
        return view('dashboards.users.list.edit', $data);
    }
    ...
    public function add()
    {
        return view('dashboards.users.list.add');
    }
    ...
    {
        return view('dashboards.users.dashboard.dashboard');
    }
    public function rekomendasi()
    {
        return view('dashboards.users.rekomendasi.rekomendasi');
    }
    public function hasil(Request $request)
    {
        ...
        return view('dashboards.users.rekomendasi.hasil', compact('hasil'));
    }

    public function tentang()
    {
        return view('dashboards.users.tentang.tentang');
    }
 ...
 // public function dashboard()
    ...
    // public function list()
    // {
    //     return view('dashboards.users.list.list');
    // }
    // public function tentang()
    // {
    //     return view('dashboards.users.tentang.tentang');
